...
def predict_secondary_structure(fasta_path, eternafold_path="/scratch/bibekar/carbonara-rna/EternaFold/src/contrafold", 
                                      params_path="/scratch/bibekar/carbonara-rna/EternaFold/parameters/EternaFoldParams.v1"):
...
def main():
    ...
    pdb_filepaths = [
        filepath for filepath in pdb_filepaths 
    ...
    for pdb_path in tqdm(pdb_filepaths, desc="Processing PDB files"):
        ...
        if pdb_id is None:
            ...
            rt.write_fasta(filepath=f'predictions/{pdb_id}.fasta', seq=seq_pred, info=f"{pdb_id} | rr={recovery_rate.item():.4f}")
        ...
        for chain_id in chain_ids:
            ...
            chain_seq_len = len(set(chain_nucleotides.res_id))  # Unique residues in the chain
