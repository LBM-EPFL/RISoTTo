...
class StatePoolLayer(pt.nn.Module):
    ...
    def forward(self, q, p, M):
        ...
        try:
            ...
            print("Ms device:", Ms.device)
            print("Memory allocated:", pt.cuda.memory_allocated())
            print("Memory cached:", pt.cuda.memory_cached())
            print("p contains nan:", pt.isnan(p).any())
            print("p contains inf:", pt.isinf(p).any())
            print("Ms contains nan:", pt.isnan(Ms).any())
            print("Ms contains inf:", pt.isinf(Ms).any())
            raise e
